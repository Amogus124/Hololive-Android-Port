function onCreate()
	-- background shit
	makeLuaSprite('limoSunset2', 'limo2/limoSunset', -120, -50);
	...
	makeAnimatedLuaSprite('limoDancer2', 'limo2/limoDancer',550, 100);
    setLuaSpriteScrollFactor('limoDancer2', 0.4, 0.4);

	makeAnimatedLuaSprite('limoDancer3', 'limo2/limoDancer',250, 100);
    setLuaSpriteScrollFactor('limoDancer3', 0.4, 0.4);
	
	makeAnimatedLuaSprite('limoDancer4', 'limo2/limoDancer',850, 100);
    setLuaSpriteScrollFactor('limoDancer4', 0.4, 0.4);
	
	makeAnimatedLuaSprite('limoDancer5', 'limo2/limoDancer',1150, 100);
